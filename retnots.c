...
static const byte racoon_stand[] = {
    Y(0x30),0x00,0x00,0x00, Y(0x30),0x01,0x00,0x08, Y(0x30),0x02,0x00,0x10,
    Y(0x38),0x10,0x00,0x00, Y(0x38),0x11,0x00,0x08, Y(0x38),0x12,0x00,0x10,
    Y(0x40),0x20,0x00,0x00, Y(0x40),0x21,0x00,0x08, Y(0x40),0x22,0x00,0x10,
};

static const byte racoon_down[] = {
    Y(0x30),0x06,0x00,0x00, Y(0x30),0x07,0x00,0x08, Y(0x30),0x08,0x00,0x10,
    Y(0x38),0x16,0x00,0x00, Y(0x38),0x17,0x00,0x08, Y(0x38),0x18,0x00,0x10,
    Y(0x40),0x26,0x00,0x00, Y(0x40),0x27,0x00,0x08, Y(0x40),0x28,0x00,0x10,
};

static const byte racoon_right[] = {
    Y(0x30),0x03,0x00,0x00, Y(0x30),0x04,0x00,0x08, Y(0x30),0x05,0x00,0x10,
    Y(0x38),0x13,0x00,0x00, Y(0x38),0x14,0x00,0x08, Y(0x38),0x15,0x00,0x10,
    Y(0x40),0x23,0x00,0x00, Y(0x40),0x24,0x00,0x08, Y(0x40),0x25,0x00,0x10,
};

static const byte racoon_left[] = {
    Y(0x30),0x05,0x40,0x00, Y(0x30),0x04,0x40,0x08, Y(0x30),0x03,0x40,0x10,
    Y(0x38),0x15,0x40,0x00, Y(0x38),0x14,0x40,0x08, Y(0x38),0x13,0x40,0x10,
    Y(0x40),0x25,0x40,0x00, Y(0x40),0x24,0x40,0x08, Y(0x40),0x23,0x40,0x10,
};
